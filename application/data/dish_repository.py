...
class DishRepository:
    ...
    def add(self, menu_id: str, submenu_id: str, title: str, description: str, price: str) -> DishDB:
    ...
    def update(self, menu_id: str, submenu_id: str, dish_id: str, title: str, description: str, price: str) -> DishDB:
        check_exception(dish_id=dish_id)
        dish = self.session.query(DishDB).filter_by(id=dish_id).first()
        dish.title = title
